...
return [
    ...
    */
    ...
    'keys' => [
        ...
        |--------------------------------------------------------------------------
        |
        | 公钥生成路径 'file://path/to/public/key'
        |
        */
        ...
        |--------------------------------------------------------------------------
        |
        | 私钥生成路径 'file://path/to/private/key'
        |
        */
    ...
    |--------------------------------------------------------------------------
    |
    | 指定 access_token 有效的时间长度（以分钟为单位），默认为1小时。
    | 您也可以将其设置为null，产生一个永不过期的令牌（不推荐）
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | 指定 access_token 可刷新的时间长度（以分钟为单位）。默认时间为 2 周。
